/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env development` (hash: ed5c179555b550ebe6833dd96c1bf2d1)
// Runtime types generated with workerd@1.20250525.0 2025-05-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WORKER_ENVIRONMENT: string;
		PG_CONNECTION_STRING: string;
		ALLOWED_ORIGINS: string;
		AUTHNZ_JWK_URL: string;
		OTEL_EXPORTER_OTLP_ENDPOINT: string;
		OTEL_EXPORTER_OTLP_AUTH_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_ENVIRONMENT" | "PG_CONNECTION_STRING" | "ALLOWED_ORIGINS" | "AUTHNZ_JWK_URL" | "OTEL_EXPORTER_OTLP_ENDPOINT" | "OTEL_EXPORTER_OTLP_AUTH_TOKEN" | "CF_ACCOUNT_ID" | "CF_API_TOKEN">> {}
}
