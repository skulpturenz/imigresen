...
export const TextArea = <T extends ValidComponent = "textarea">(
	...
	<TextFieldPrimitive
		...
		class={cn(
			...
			"focus-visible:ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none",
			"focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed",
			"disabled:opacity-50 md:text-sm transition-shadow text-foreground",
